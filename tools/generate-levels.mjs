...
const levelGuides = [
  ...
  "猫咪轮廓里藏着颜色循环", "蛋糕分层整片搬运", "左右翅膀交替归位", "先看皇冠尖角的颜色", "托盘20格：24颗豆群分两轮",
  "整节车厢搬运，余下4颗第二轮归位", "让鲸身色块像海浪一样接力", "先腾空一面帆，再完成船身", "从高低楼顶判断颜色去向", "让音符按节拍整片落豆",
...
const candyTrain = composeHorizontal([
  ["..AA..", ".AAAA.", "AAAAAA", "AAAAAA", ".AAAA.", ".A..A."],
  [".BBBB.", "BBBBBB", "BBBBBB", ".BBBB.", ".B..B.", ".B..B."],
  ["CCCCCC", "C....C", "CCCCCC", ".CCCC.", ".CCCC.", ".C..C."],
  [".DDDD.", "DDDDDD", "DDDDDD", ".DDDD.", ".D..D.", ".D..D."],
]);
